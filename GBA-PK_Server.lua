...
function GetPosition()
	...
	--	if TempVar2 == 0 then console:createBuffer("MapID: " .. TempMapData) end
	...
	if PlayerID == 1 then
		...
		--Male sprite
		PlayerExtra2 = 0
		--160 is male, 392 is female, 320 is male bike, 552 is female bike
		if Bike == 320 or Bike == 552 then
...
function NoPlayersIfScreen()
	...
	--	if TempVar2 == 0 then console:createBuffer("ScreenData: " .. ScreenData1 .. " " .. ScreenData2 .. " " .. ScreenData3) end
		...
		--If another player is loading into another map
		if PlayerID ~= 1 then
			if NewMap ~= 0 then
				NewMap = 0
				MapX = NewMapX
...
function CalculateCamera()
	...
	--	if PlayerYCameraTemp ~= 0 then console:createBuffer("PlayerYCamera: " .. PlayerYCamera .. "Player Y temp: " .. PlayerYCameraTemp) end
...
--		if TempVar2 == 0 then console:createBuffer("PlayerY2POS: " .. NewMapY2Pos) end
		...
		--if TempVar2 == 0 then console:createBuffer("Player Y: " .. PlayerMapY .. "Player 2 added y: " .. NewMapY2Pos) end
